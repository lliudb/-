;(function($WIN,$){
    ...
    var STATUS_FSM = [
        'CURR' : {},
        'LIST' : [
            'DRAWING'   : {desc:"绘制中...",     v:1, k:"DRAWING",   cursor:"move"},
            'EDITING'   : {desc:"编辑中...",     v:2, k:"EDITING",   cursor:"move"},
            'SAVING'    : {desc:"正在保存...",   v:3, k:"SAVING",    cursor:"move"},
            'SELECTING' : {desc:"正在选择...",   v:4, k:"SELECTING", cursor:"move"},
            'MOVING'    : {desc:"画布移动中...", v:5, k:"MOVING",    cursor:"move"},
            'IDLE'      : {desc:"无操作",        v:0, k:"IDLE",      cursor:"move"},
        ],
        'ALLOW': [],
        'DENY' : [],
    ];
    ...
    var STATUS = {
        "CURR_STATUS"   : {desc:"无操作",        v:1, k:"DRAWING",   cursor:"move"},
        'DRAWING'       : {desc:"绘制中...",     v:1, k:"DRAWING",   cursor:"move"},
        'EDITING'       : {desc:"编辑中...",     v:2, k:"EDITING",   cursor:"move"},
        'SAVING'        : {desc:"正在保存...",   v:3, k:"SAVING",    cursor:"move"},
        'SELECTING'     : {desc:"正在选择...",   v:4, k:"SELECTING", cursor:"move"},
